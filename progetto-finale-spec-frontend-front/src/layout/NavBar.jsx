    ...
    <nav className="navbar navbar-expand-lg custom-navbar mr-4">
      <div className="container-fluid">
        ...
        <Link className="navbar-brand d-flex align-items-center" to="/">
          ...
          <span className="fw-bold d-none display-4 d-md-inline">
            JohnPepper
          </span>
        </Link>
        ...
        >
          <ul className="navbar-nav mx-auto w-100 align-items-center justify-content-center ">
            <li
              className="nav-item d-flex align-items-center  w-100 d-lg-none"
              style={{ gap: "8px" }}
            >
            ...
            <li
              className="nav-item d-flex align-items-center justify-content-between w-100 d-lg-none"
              style={{ gap: "8px" }}
            >
              <div className="d-flex flex-grow-1">
                <Link
            ...
            <li className="nav-item d-none d-lg-block">
              <Link
                className={`nav-link${
                  location.pathname === "/category/freschi" ? " active" : ""
                }`}
                to="/products"
              >
                Prodotti
